...
export default function AnalyticsPerformanceChart() {
  ...
  const seriesData = [
    {
      data: p95.length ? p95 : dataMap[view].salesData,
      label: p95.length ? 'P95 Latency (ms)' : 'Sales Growth',
      id: 'sales',
      color: theme.palette.primary.main,
      visible: visibilityOption['sales']
    },
    {
      data: tps.length ? tps : dataMap[view].targetData,
      label: tps.length ? 'Throughput (req/s)' : 'Target',
      id: 'target',
